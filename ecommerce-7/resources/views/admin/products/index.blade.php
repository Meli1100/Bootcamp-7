                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mb-4">
                        <form method="GET" action="{{ route('admin.products.index') }}" class="flex items-center gap-2">
                            <input type="text" name="search" placeholder="Cari produk..." value="{{ request('search') }}" class="px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-blue-500">
                                    ...
                                    <tr class="border-b hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 text-sm space-x-2 flex">
                                            <a href="{{ route('product.detail', $product->slug) }}" 
                                                class="px-3 py-1 bg-emerald-500 text-white rounded hover:bg-emerald-600 transition text-xs font-semibold">
                                                    Lihat
                                            </a>
