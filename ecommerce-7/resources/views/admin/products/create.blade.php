                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input id="image_input" name="image_file" type="file" class="mt-1 block w-full" required accept="image/jpeg,image/png,image/jpg,image/gif,image/webp" />
                        ...
                        <div id="crop-container" class="hidden mt-4">
                        ...
                        <div>
                            ...
                            <x-text-input id="price" name="price" type="number" step="1" min="0" class="mt-1 block w-full" value="{{ old('price') }}" required />
