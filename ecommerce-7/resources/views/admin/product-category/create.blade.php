                    ...
                    <form method="POST" action="{{ route('admin.product-categories.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                name="name" 
                                id="name"
                                class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 @error('name') @else border-gray-300 focus:ring-blue-500 @enderror"
                                value="{{ old('name') }}"
                        ...
                        <div>
                            ...
                            <textarea 
                                ...
                                id="description"
                                rows="5"
                                class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 @error('description') @else border-gray-300 focus:ring-green-500 @enderror"
