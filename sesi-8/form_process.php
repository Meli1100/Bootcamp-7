...
$errors = [];
$values = ['nama' => '', 'price' => '', 'description' => '', 'category' => '', 'image' => null];
$valid = false;
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $values['image'] = $_FILES['image'] ?? null;
    ...
    if (!$values['image'] || $values['image']['error'] !== UPLOAD_ERR_OK) {
                ...
                <?php if ($valid): ?>
                    <div class="alert alert-success" role="alert">
                        ...
                        <ul>
                            ...
                            <li><strong>Image:</strong> <?= htmlspecialchars($values['image']['name']) ?></li>
                        </ul>
                    </div>
                <?php endif; ?>
    ...
    <script>
        ...
        form.addEventListener('submit', function(e) {
            ...
            if (!image) {
                ...
                var err = document.createElement('div');
                err.className = 'invalid-feedback';
                err.textContent = 'Please upload a product image.';
                imageEl.parentNode.appendChild(err);
            }
